"""
Steganography panel - a thin UI over the StegKit library (packages/stegkit,
imported via engine_bridge). Reuses its
    ...
    def _build(self):
        ...
        if not eng.STEGO_OK:
            msg = QLabel("StegKit unavailable:\n" + str(eng.STEGO_ERROR) +
                         "\n\nEnsure packages/stegkit exists in the repo "
                         "and Pillow/numpy/"
