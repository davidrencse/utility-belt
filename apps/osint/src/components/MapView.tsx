...
export function MapView({ points, active = true }: { points: GeoPoint[]; active?: boolean }) {
  ...
  // The map stays mounted while its tab is hidden (display:none gives it a 0×0
  // canvas); re-measure when it becomes visible again.
  useEffect(() => {
