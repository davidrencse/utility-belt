...
from .osi import add_tag_counts, derive_osi_tags_from_analysis_packet, derive_osi_tags_from_decoded, empty_tag_summary
...
class AnalysisContext:
    ...
    # Running per-layer tag counts (was a per-packet list of tag lists).
    osi_summary: Dict[str, Dict[str, int]]
...
class AnalysisEngine:
    def __init__(self,
        ...
        self.context = AnalysisContext(
            ...
            osi_summary=empty_tag_summary(),
        )
        for analyzer in self.analyzers:
            analyzer.on_start(self.context)
        self._packet_hooks = [a.on_packet for a in self.analyzers]
    ...
    def process_packet(self, decoded) -> None:
        ...
        add_tag_counts(self.context.osi_summary, derive_osi_tags_from_decoded(decoded))
        ...
        for on_packet in self._packet_hooks:
    ...
    def process_packet_dict(self, payload: Dict) -> None:
        ...
        add_tag_counts(self.context.osi_summary, derive_osi_tags_from_analysis_packet(packet))
    ...
    def finalize(self) -> AnalysisReport:
        ...
        report = AnalysisReport(
            ...
            osi_summary=self.context.osi_summary,
        )
        return report
